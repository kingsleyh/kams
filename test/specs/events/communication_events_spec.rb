...
describe Communication do
  ...
  #it "should return correct response for say with emoticon frown :( with target and pre and exclaims" do
  #  event = Event.new(:Communication, {:action => :say, :phrase => 'hello :( man!', :pre => 'slowly', :target => 'spiderman'})
  #  player = double(:player)
  #  room = double(:room)
  #  target_player = double(:target_player, :name => 'spiderman')
  #
  ...
  #                        :target => target_player,
  #                        :type => :Communication,
  #                        :to_target => 'slowly, superman frowns and exclaims to you, <say>"Hello!"</say>',
  #                        :to_player => 'slowly, you frown and exclaim to spiderman, <say>"Hello!"</say>',
  #                        :to_other => 'slowly, superman frowns and exclaims to spiderman, <say>"Hello!"</say>',
  #                        :to_blind_target => 'Someone frowns and exclaims, <say>"Hello!"</say>',
  #                        :to_blind_other => 'Someone frowns and exclaims, <say>"Hello!"</say>',
  #                        :to_deaf_target => 'You see superman say something to you.',
  #                        :to_deaf_other => 'You see superman say something to spiderman.')
  #
  #  player.should_receive(:name).exactly(4).times.and_return('superman')
